...
class Agent:
    def __init__(self, start_x, start_y, grid_world): # Geef start coords
        self.x = start_x
        self.y = start_y
    ...
    def move_agent(self, direction): # Beweeg de agent in een bepaalde richting, en check dat het niet out of bounds/in muren loopt.
